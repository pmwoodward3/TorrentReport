...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>
      ...
      is collected and recorded by Torrent Report and how we use it.
    </p>
    ...
    <p>
      Torrent Report follows a standard procedure of using log files. These files log visitors when
    ...
    <p>
      For additional cookie information please see our{' '}
      <Link to="/policy/cookies">Cookie Policy</Link>
    </p>
    <p>
      Like any other website, Torrent Report uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      https://www.torrent.report and other sites on the internet. However, visitors may choose to
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Torrent
      Report, which are sent directly to users' browser. They automatically receive your IP address
    ...
    <p>
      Note that Torrent Report has no access to or control over these cookies that are used by
    ...
    <p>
      Torrent Report's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      ...
      <a rel="noopener noreferrer" target="_blank" href="http://www.whatarecookies.com/">
        What Are Cookies?
      </a>
    </p>
    ...
    <p>
      Torrent Report does not knowingly collect any Personal Identifiable Information from children
