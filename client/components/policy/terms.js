...
const Terms = () => (
  <div>
    ...
    <p>
      These terms and conditions outline the rules and regulations for the use of Torrent Report's
      Website, located at https://www.torrent.report.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions, our{' '}
      <Link to="/policy/cookies">Cookie Policy</Link>, and our{' '}
      <Link to="/policy/privacy">Privacy Policy</Link>. Do not continue to use Torrent Report if you
    ...
    <p>
      We employ the use of cookies. By accessing Torrent Report, you agreed to use cookies in
      agreement with the Torrent Report's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Torrent Report and/or its licensors own the intellectual property
      rights for all material on Torrent Report. All intellectual property rights are reserved. You
      may access this from Torrent Report for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Torrent Report</li>
      <li>Sell, rent or sub-license material from Torrent Report</li>
      <li>Reproduce, duplicate or copy material from Torrent Report</li>
      <li>Redistribute content from Torrent Report</li>
    </ul>
    ...
    <p>
      ...
      information in certain areas of the website. Torrent Report does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views and
      opinions of Torrent Report,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, Torrent Report shall not be liable for the Comments or for any liability,
      damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
      appearance of the Comments on this website.
    </p>

    <p>
      Torrent Report reserves the right to monitor all Comments and to remove any Comments which can
    ...
    <p>
      You hereby grant Torrent Report a non-exclusive license to use, reproduce, edit and authorize
    ...
    <p>
      ...
      visibility of the hyperlink compensates the absence of Torrent Report; and (d) the link is in
    ...
    <p>
      ...
      to our website, you must inform us by sending an e-mail to Torrent Report. Please include your
    ...
    <p>
      No use of Torrent Report's logo or other artwork will be allowed for linking absent a
